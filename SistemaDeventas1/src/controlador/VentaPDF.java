...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String rtn = "0801199621622";
            String nombre = "Anthony Cooporation";
            String telefono = "31477922";
            String direccion = "Comayagua City";
            String razon = "Proyecto de Programacion, Clase Lenguajes de Programacion";
